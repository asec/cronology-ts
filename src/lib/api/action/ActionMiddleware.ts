...
export type ActionMiddlewareNextFunction = () => Promise<ApiResponse<ApiResponseDTO>> | ApiResponse<ApiResponseDTO>;
...
export default abstract class ActionMiddleware<TContext extends Record<string, any>, TAction extends ApiAction<ApiResponseDTO, ApiParamsDTO>>
{
    ...
    protected abstract do(action: TAction, context: TContext, next: ActionMiddlewareNextFunction): Promise<ApiResponse<ApiResponseDTO>> | ApiResponse<ApiResponseDTO>
